package com.anjilibey.kooryuk.view.MeetingKaban;
...
public class ViewMeeting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPrefManager = new SharedPrefManager(ViewMeeting.this);
        ...
        mApiService.viewRapatRequest(
            ...
            public void onResponse(Call<RapatList> call, Response<RapatList> response) {
                if (response.isSuccessful()){
                    ...
                    loading.dismiss();
                    Toast.makeText(ViewMeeting.this, "Data Rapat kosong", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<RapatList> call, Throwable t) {
                loading.dismiss();
                Toast.makeText(ViewMeeting.this, "Koneksi Internet Bermasalah", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void generateRapatList(ArrayList<Rapat> empDataList) {
        ...
        RapatAdapter adapter = new RapatAdapter(empDataList);

        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(ViewMeeting.this);
