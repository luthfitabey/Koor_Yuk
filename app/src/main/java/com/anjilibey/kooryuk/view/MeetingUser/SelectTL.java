...
import com.anjilibey.kooryuk.viewModel.TLAdapterUser;
...
public class SelectTL extends AppCompatActivity {
...
//        toolbar();
        ...
        sharedPrefManager = new SharedPrefManager(SelectTL.this);
        ...
        mApiService.viewRapatRequest(
            ...
            public void onResponse(Call<RapatList> call, Response<RapatList> response) {
                if (response.isSuccessful()){
                    ...
                    loading.dismiss();
                    Toast.makeText(SelectTL.this, "Data Rapat kosong", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<RapatList> call, Throwable t) {
                loading.dismiss();
                Toast.makeText(SelectTL.this, "Koneksi Internet Bermasalah", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void generateRapatList(ArrayList<Rapat> empDataList) {
        ...
        TLAdapterUser adapter = new TLAdapterUser(empDataList);

        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(SelectTL.this);
