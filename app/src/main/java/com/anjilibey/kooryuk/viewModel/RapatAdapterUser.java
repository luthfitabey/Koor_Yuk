...
public class RapatAdapterUser extends RecyclerView.Adapter<RapatAdapterUser.ViewHolder> {
    private ArrayList<Rapat> result;

    public RapatAdapterUser(ArrayList<Rapat> result) {
        this.result = result;
    }

    @Override
    public RapatAdapterUser.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RapatAdapterUser.ViewHolder viewHolder, int i) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent mIntent = new Intent(view.getContext(), ViewMeetingUser.class);
